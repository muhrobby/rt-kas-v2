      ...
      <div className="p-6">
        <div className="mb-3 flex items-start justify-between gap-2">
          <div>
            ...
            <h2 className="mt-1 text-xl text-[var(--kanvas-ink)]">Hapus Kategori</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <p className="mt-2 text-[12px] text-[var(--kanvas-ink-3)]">
          Kategori yang sudah dipakai transaksi tidak bisa dihapus.
        </p>

        {serverError ? (
          <p className="mt-3 text-[12px] text-[var(--kanvas-danger)]">{serverError}</p>
        ) : null}

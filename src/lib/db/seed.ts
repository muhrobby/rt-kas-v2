...
async function main() {
  ...
  const wargaData = [
    { namaKepalaKeluarga: "Bpk. Ahmad Fauzi", blokRumah: "A1", noTelp: "08111000001", statusHunian: "tetap" as const, isPengurus: true, rolePengurus: "Ketua RT" },
    { namaKepalaKeluarga: "Bpk. Bambang Sutrisno", blokRumah: "A2", noTelp: "08111000002", statusHunian: "tetap" as const, isPengurus: true, rolePengurus: "Bendahara" },
    { namaKepalaKeluarga: "Bpk. Candra Wijaya", blokRumah: "A3", noTelp: "08111000003", statusHunian: "tetap" as const, isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Dedi Kurniawan", blokRumah: "B1", noTelp: "08111000004", statusHunian: "tetap" as const, isPengurus: true, rolePengurus: "Sekretaris" },
    { namaKepalaKeluarga: "Bpk. Eko Prasetyo", blokRumah: "B2", noTelp: "08111000005", statusHunian: "tetap" as const, isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Fajar Nugroho", blokRumah: "B3", noTelp: "08111000006", statusHunian: "kontrak" as const, tglBatasDomisili: "2026-12-31", isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Gunawan Saputra", blokRumah: "C1", noTelp: "08111000007", statusHunian: "kontrak" as const, tglBatasDomisili: "2026-06-30", isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Hendra Susanto", blokRumah: "C2", noTelp: "08111000008", statusHunian: "tetap" as const, isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Irwan Hidayat", blokRumah: "C3", noTelp: "08111000009", statusHunian: "tetap" as const, isPengurus: false },
    { namaKepalaKeluarga: "Bpk. Joko Purnomo", blokRumah: "D1", noTelp: "08111000010", statusHunian: "tetap" as const, isPengurus: false },
  ];
